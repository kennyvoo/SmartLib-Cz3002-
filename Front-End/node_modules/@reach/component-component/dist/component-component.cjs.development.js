...

{
  ...
  Component.propTypes = {
    ...
    getInitialState: PropTypes__default['default'].func,
    refs: PropTypes__default['default'].object,
    getRefs: PropTypes__default['default'].func,
    didMount: PropTypes__default['default'].func,
    didUpdate: PropTypes__default['default'].func,
    willUnmount: PropTypes__default['default'].func,
    getSnapshotBeforeUpdate: PropTypes__default['default'].func,
